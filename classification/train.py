...
if __name__ == "__main__":
    ...
    parser.add_argument('--stringlist', type = str, default = 'mapping_string.txt', help = 'mapping_string')
    parser.add_argument('--scalarlist', type = str, default = 'mapping_scalar.txt', help = 'mapping_scalar')
    ...
    parser.add_argument('--task', type = str, default = 'rgb', help = 'gray | rgb | inpainting')
